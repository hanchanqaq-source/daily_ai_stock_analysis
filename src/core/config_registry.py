...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    # Full-data backup may preserve these non-sensitive runtime controls, but
    # they remain intentionally hidden from the ordinary web settings UI.
    "SQLITE_WAL_ENABLED": {
        "title": "SQLite WAL Enabled",
        "description": "Enable SQLite write-ahead logging for file databases.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 900,
        "help_key": "",
        "examples": ["SQLITE_WAL_ENABLED=true"],
        "docs": [],
        "warning_codes": ["restart_required"],
    },
    "SQLITE_BUSY_TIMEOUT_MS": {
        "title": "SQLite Busy Timeout",
        "description": "Milliseconds SQLite waits for a competing writer.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 901,
        "help_key": "",
        "examples": ["SQLITE_BUSY_TIMEOUT_MS=5000"],
        "docs": [],
        "warning_codes": ["restart_required"],
    },
    "SQLITE_WRITE_RETRY_MAX": {
        "title": "SQLite Write Retry Maximum",
        "description": "Maximum retries for retryable SQLite write contention.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 902,
        "help_key": "",
        "examples": ["SQLITE_WRITE_RETRY_MAX=3"],
        "docs": [],
        "warning_codes": ["restart_required"],
    },
    "SQLITE_WRITE_RETRY_BASE_DELAY": {
        "title": "SQLite Write Retry Base Delay",
        "description": "Base delay in seconds for SQLite write retries.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 903,
        "help_key": "",
        "examples": ["SQLITE_WRITE_RETRY_BASE_DELAY=0.1"],
        "docs": [],
        "warning_codes": ["restart_required"],
    },
    "USE_PROXY": {
        "title": "Process Proxy Enabled",
        "description": "Enable the configured process HTTP proxy after safe startup recovery.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 904,
        "help_key": "",
        "examples": ["USE_PROXY=false"],
        "docs": [],
        "warning_codes": ["restart_required"],
    },
    "PROXY_HOST": {
        "title": "Process Proxy Host",
        "description": "Host name used when process proxy support is enabled.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 905,
        "help_key": "",
        "examples": ["PROXY_HOST=127.0.0.1"],
        "docs": [],
        "warning_codes": ["restart_required"],
    },
    "PROXY_PORT": {
        "title": "Process Proxy Port",
        "description": "TCP port used when process proxy support is enabled.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
...
def build_schema_response() -> Dict[str, Any]:
    ...
    for key in sorted(_FIELD_DEFINITIONS.keys() - WEB_SETTINGS_HIDDEN_FROM_UI):
