...
| R7-Hotfix｜Windows 安装器补丁 | 修复 v3.29.0 `System.dll / 0xC0000005` 引导崩溃 | 实施中 | Work8 / Draft PR #17；本地实现通过，固定 Head CI 待运行 |
...
- 本地 Desktop `81/81`、安装器与打包专项 `23/23` 通过；真实 Windows 安装器生命周期
  与 macOS 打包等待该 PR 固定 Head GitHub Actions。
