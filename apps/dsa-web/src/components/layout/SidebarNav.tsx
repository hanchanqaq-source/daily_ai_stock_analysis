...
import { Activity, BarChart3, Bell, BriefcaseBusiness, CalendarRange, Gauge, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'period-report', labelKey: 'layout.nav.periodReport', to: '/period-report', icon: CalendarRange },
